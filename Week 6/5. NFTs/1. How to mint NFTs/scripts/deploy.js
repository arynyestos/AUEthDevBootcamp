async function main() {
  ...
  const MyToken = await hre.ethers.getContractFactory("CaptainBitcoin");
  ...
  await nft.safeMint(await signer0.getAddress(), "ipfs://QmT9cSe9iRjRNZ4DmdNxufi73MTQcvTp7BrBkfxpWfyxU6");
